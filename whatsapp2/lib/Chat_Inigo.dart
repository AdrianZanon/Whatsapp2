...
class Chat_Inigo extends StatefulWidget {
  final Chat chat;

  Chat_Inigo({required this.chat});

  @override
  _Chat_InigoState createState() => _Chat_InigoState();
}

class _Chat_InigoState extends State<Chat_Inigo> {
  final TextEditingController _messageController = TextEditingController();
  final String _fileName = 'chat_data_elvirrrra.json';
