...
class Chat_Rodri extends StatefulWidget {
  final Chat2 chat;

  Chat_Rodri({required this.chat});

  @override
  _Chat_InigoState createState() => _Chat_InigoState();
}

class _Chat_InigoState extends State<Chat_Rodri> {
  final TextEditingController _messageController = TextEditingController();
  final String _fileName = 'chat_data_elvirra.json';
