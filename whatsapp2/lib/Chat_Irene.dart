...
class Chat_Irene extends StatefulWidget {
  final Chat1 chat;

  Chat_Irene({required this.chat});

  @override
  _Chat_IreneState createState() => _Chat_IreneState();
}

class _Chat_IreneState extends State<Chat_Irene> {
  final TextEditingController _messageController = TextEditingController();
  final String _fileName = 'chat_data_irene.json';
